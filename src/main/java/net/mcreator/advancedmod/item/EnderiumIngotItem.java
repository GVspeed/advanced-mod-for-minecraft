...
public class EnderiumIngotItem extends AdvancedModModElements.ModElement {
	@ObjectHolder("advanced_mod:enderium_ingot")
	public static final Item block = null;
	public EnderiumIngotItem(AdvancedModModElements instance) {
		super(instance, 37);
	}
