	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AdvancedModMod.LOGGER.warn("Failed to load dependency world for procedure CopperArmorBootsTickEvent!");
			return;
		}
		...
		new Object() {
			...
			private void run() {
				...
				if (entity instanceof LivingEntity)
					((LivingEntity) entity).addPotionEffect(new EffectInstance(Effects.SPEED, (int) 10, (int) 3));
